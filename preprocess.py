...
# === Parameters ===
MAX_LINES = 50               # Max number of lines in code function
MAX_SEQ_LEN = 256            # Max tokens per code/docstring
...
def encode_dataset(dataset, tokenizer):
    def encode(example):
        ...
        doc_ids = tokenizer.encode(example["func_documentation_string"]).ids[:MAX_SEQ_LEN]
...
if __name__ == "__main__":
    ...
    tokenized_valid.save_to_disk("valid_tokenized")
